...
{
	internal class Dump210 : BaseModule, OnEventEvent
	{
		...
		public Dump210()
			: base("Dump Event 210", "Dumps Event 210", Main.Instance.SettingsButtonDumping, null, isToggle: true, save: true)
		{
		}
		...
		public bool OnEvent(EventData eventData)
		{
			if (eventData.Code == 210)
			{
				...
				File.WriteAllBytes("Area51\\Dumps\\Event210", array);
