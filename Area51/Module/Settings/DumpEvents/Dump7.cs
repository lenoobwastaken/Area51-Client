...
{
	internal class Dump7 : BaseModule, OnEventEvent
	{
		private int loggcount;

		private int loglimit = 170;

		public Dump7()
			: base("Dump Event 7", "Dumps Event 7", Main.Instance.SettingsButtonDumping, null, isToggle: true, save: true)
		{
		}
		...
		public bool OnEvent(EventData eventData)
		{
			if (eventData.Code == 7)
			{
				...
				File.WriteAllBytes("Area51\\Dumps\\Event7", array);
