...
{
	internal class Dump209 : BaseModule, OnEventEvent
	{
		...
		public Dump209()
			: base("Dump Event 209", "Dumps Event 209", Main.Instance.SettingsButtonDumping, null, isToggle: true, save: true)
		{
		}
		...
		public bool OnEvent(EventData eventData)
		{
			if (eventData.Code == 209)
			{
				...
				File.WriteAllBytes("Area51\\Dumps\\Event209", array);
