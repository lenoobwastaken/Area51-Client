...
{
	internal class RetroTheme : BaseModule, OnUpdateEvent
	{
		...
		public RetroTheme()
			: base("Retro\nTheme", "Enable Area51 Theme", Main.Instance.SettingsButtonTheme, ButtonIcons.MovementMenu, isToggle: true)
		{
		}
		...
		public override void OnEnable()
		{
			try
			{
				...
				GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/BackgroundLayer01").GetComponent<Image>().sprite = ButtonIcons.Retro;
		...
		public async Task setUITheme(int WaitToUpdate)
		{
			for (int i = 0; i < WaitToUpdate; i++)
			{
				...
				if (GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/BackgroundLayer02").GetComponent<Image>().color != Color.white)
				{
					...
					GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/Menu_Dashboard/ScrollRect/Viewport/VerticalLayoutGroup/Buttons_QuickActions/ Button_InteractionPauseWithState/Icon").GetComponent<Image>().color = Color.white;
					...
					GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/Menu_Dashboard/ScrollRect/Viewport/VerticalLayoutGroup/Buttons_QuickActions/ Button_InteractionPauseWithState/Text_H4").GetComponent<TextMeshProUGUI>().color = Color.white;
