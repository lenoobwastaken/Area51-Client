...
{
	internal class ButtonsBlue : BaseModule, OnUpdateEvent
	{
		...
		public ButtonsBlue()
			: base("Buttons\nBlue", "Enable Blue Buttons", Main.Instance.SettingsButtonTheme, ButtonIcons.MovementMenu, isToggle: true)
		{
		}
		...
		public async Task setUITheme(int WaitToUpdate)
		{
			for (int i = 0; i < WaitToUpdate; i++)
			{
				...
				GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/Page_Buttons_QM/HorizontalLayoutGroup/Area 51 ClientTab/Icon").GetComponent<Image>().color = Color.blue;
				...
				if (GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/BackgroundLayer02").GetComponent<Image>().color != Color.white)
				{
					...
					GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/Menu_Dashboard/ScrollRect/Viewport/VerticalLayoutGroup/Buttons_QuickActions/ Button_InteractionPauseWithState/Icon").GetComponent<Image>().color = Color.blue;
					GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/Menu_Dashboard/ScrollRect/Viewport/VerticalLayoutGroup/Buttons_QuickActions/ Button_InteractionPauseWithState/Text_H4").GetComponent<TextMeshProUGUI>().color = Color.blue;
