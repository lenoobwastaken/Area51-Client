...
{
	internal class AlienTheme : BaseModule, OnUpdateEvent
	{
		...
		public AlienTheme()
			: base("Space Theme", "Enable Area51 Theme", Main.Instance.SettingsButtonTheme, ButtonIcons.MovementMenu, isToggle: true)
		{
		}
